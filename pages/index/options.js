...
export const columns = [
  { key: 'statement_date', dataKey: 'statement_date', title: '日期', width: 100, sortable: true },
  ...
  { key: 'viewers_count', dataKey: 'viewers_count', title: '观看人数', width: 90, align: 'center' },
  { key: 'views_count', dataKey: 'views_count', title: '观看次数', width: 90, align: 'center' },
  ...
  { key: 'is_settled', dataKey: 'is_settled', title: '状态', width: 80, align: 'center' },
